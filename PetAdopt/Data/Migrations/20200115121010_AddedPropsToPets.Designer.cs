...
namespace PetAdopt.Data.Migrations
{
    ...
    [Migration("20200115121010_AddedPropsToPets")]
    partial class AddedPropsToPets
    {
            ...
            modelBuilder.Entity("PetAdopt.Models.Cat", b =>
                {
                    b.HasOne("PetAdopt.Models.Owner", "Owner")
                        .WithOne("Cat")
                        .HasForeignKey("PetAdopt.Models.Cat", "OwnerForeignKey")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("PetAdopt.Models.Dog", b =>
                {
                    b.HasOne("PetAdopt.Models.Owner", "Owner")
                        .WithOne("Dog")
                        .HasForeignKey("PetAdopt.Models.Dog", "OwnerForeignKey")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("PetAdopt.Models.Reptile", b =>
                {
                    b.HasOne("PetAdopt.Models.Owner", "Owner")
                        .WithOne("Reptile")
                        .HasForeignKey("PetAdopt.Models.Reptile", "OwnerForeignKey")
                        .OnDelete(DeleteBehavior.Cascade);
                });
