...
namespace PetAdopt.Data.Migrations
{
    ...
    [Migration("20200116032052_ChangedFKUser&Owner&Adopter")]
    partial class ChangedFKUserOwnerAdopter
    {
            ...
            modelBuilder.Entity("PetAdopt.Models.Adopter", b =>
                {
                    b.HasOne("PetAdopt.ApplicationUser", "ApplicationUser")
                        .WithOne("Adopter")
                        .HasForeignKey("PetAdopt.Models.Adopter", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("PetAdopt.Models.Owner", b =>
                {
                    ...
                    b.HasOne("PetAdopt.ApplicationUser", "ApplicationUser")
                        .WithOne("Owner")
                        .HasForeignKey("PetAdopt.Models.Owner", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
